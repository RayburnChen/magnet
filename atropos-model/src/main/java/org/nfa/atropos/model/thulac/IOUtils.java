...
public final class IOUtils {
	 ...
	 *
	 * @param input
	 *            the file path to read from, not null.
	 * @return The mapped byte buffer
	 * @throws IOException
	 *             If some other I/O error occurs
	 */
	public static MappedByteBuffer mapToByteBuffer(final String input) throws IOException {
		FileChannel channel = FileChannel.open(new ClassPathResource(input).getFile().toPath(), StandardOpenOption.READ);
