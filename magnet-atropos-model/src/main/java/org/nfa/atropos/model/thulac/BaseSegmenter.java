...
import static org.nfa.atropos.model.thulac.CwsModel.PocMark.POS_B_CHAR;
import static org.nfa.atropos.model.thulac.CwsModel.PocMark.POS_E_CHAR;
import static org.nfa.atropos.model.thulac.CwsModel.PocMark.POS_M_CHAR;
import static org.nfa.atropos.model.thulac.CwsModel.PocMark.POS_S_CHAR;
...
import org.nfa.atropos.model.thulac.Ruler.CleanedSentence;
...
public abstract class BaseSegmenter<T> {
	...
	public List<T> segment(String sentence) {
		...
		int[] labels = Decoder.viterbiDecode(model, cleanedSentence, previousTrans);
